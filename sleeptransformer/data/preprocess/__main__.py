...
from sleeptransformer.data.preprocess.process_functions import process_fns
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data-dir", type=Path, required=True, help="Path to EDF data.")
    parser.add_argument("-o", "--output-dir", type=Path, default=True, help="Where to store H5 files.")
    parser.add_argument("-ch", "--channels", type=str, nargs="+", default=None, help="Channels to extract.")
    ...
    parser.add_argument('--current-split', type=int, default=1, help="Use this to indicate the current split out of the total number of splits.")
    ...
    parser.add_argument('--transform', type=str, default=None, choices=['none', 'stft', 'cwt', 'multitaper'], help='Type of time-frequency transformation to perform.')
